...
@RestController
@RequestMapping("/api/online-auction-kafka")
public class OnlineAuctionKafkaResource {

    private final Logger log = LoggerFactory.getLogger(OnlineAuctionKafkaResource.class);
    ...
    public OnlineAuctionKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
