...
export const ProductCategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineAuctionApp.productCategory.delete.question">
        <Translate contentKey="onlineAuctionApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
