...
export const UsersDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineAuctionApp.users.delete.question">
        <Translate contentKey="onlineAuctionApp.users.delete.question" interpolate={{ id: usersEntity.id }}>
