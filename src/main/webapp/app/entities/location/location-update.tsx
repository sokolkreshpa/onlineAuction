  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="onlineAuctionApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="onlineAuctionApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('onlineAuctionApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('onlineAuctionApp.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('onlineAuctionApp.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('onlineAuctionApp.location.country')}
                id="location-country"
                name="country"
                data-cy="country"
                type="text"
